...
import pt.up.hs.project.config.KafkaProperties;
...
class ProjectKafkaResourceIT {
    ...
    void setup() {
        ...
        ProjectKafkaResource kafkaResource = new ProjectKafkaResource(kafkaProperties);
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/project-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
